...
class IMovEquipVisitTercRoomDatasourceTest {
    ...
    fun `setSent - Check return failure in setSent if not have mov`() = runTest {
        ...
        assertEquals(
            ...
            "java.lang.NullPointerException: Cannot invoke \"br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipVisitTercRoomModel.setStatusSendMovEquipVisitTerc(br.com.usinasantafe.pcp.utils.StatusSend)\" because \"roomModel\" is null"
        )
    }
