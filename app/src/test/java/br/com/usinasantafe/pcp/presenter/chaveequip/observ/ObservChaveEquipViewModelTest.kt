...
class ObservChaveEquipViewModelTest {
    ...
    fun `setObserv - Check return failure if have error in SetObservMovChave - RECEIPT - ADD`() =
        runTest {
            ...
            assertEquals(
                ...
                "ObservChaveEquipViewModel.setObserv -> ISetObservMovChaveEquip -> java.lang.Exception"
            )
        }
    ...
    fun `setObserv - Check return failure if have error in SaveMovChave - RECEIPT - ADD`() =
        runTest {
            ...
            assertEquals(
                viewModel.uiState.value.failure,
                "ObservChaveEquipViewModel.setObserv -> ISaveMovChave -> java.lang.Exception"
            )
        }
    ...
    fun `getObserv - Check return failure if have error in GetObservMovChaveEquip`() =
        runTest {
            ...
            assertEquals(
                viewModel.uiState.value.failure,
                "ObservChaveEquipViewModel.getObserv -> IGetObservMovChaveEquip -> java.lang.Exception"
            )
        }
