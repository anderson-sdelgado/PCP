    ...
    fun `checkSend - Check return failure if have error in MovChaveRoomDatasource checkSend`() =
        runTest {
            whenever(
                ...
                Result.failure(
                    DatasourceException(
                        function = "MovChaveRoomDatasource.checkSend",
                        cause = Exception()
                    )
                )
            )
    ...
    fun `listSend - Check return failure if have error in MovChaveRoomDatasource listSend`() =
        runTest {
            whenever(
                ...
                Result.failure(
                    DatasourceException(
                        function = "MovChaveRoomDatasource.listSend",
                        cause = Exception()
                    )
                )
            )
    ...
    fun `send - Check return failure if have error in MovChaveRetrofitDatasource send`() =
        runTest {
            ...
            whenever(
                ...
                Result.failure(
                    DatasourceException(
                        function = "MovChaveRetrofitDatasource.send",
                        cause = Exception()
                    )
                )
            )
    ...
    fun `setSent - Check return failure if have error in MovChaveRepository setSent`() =
        runTest {
            ...
            whenever(
                ...
                Result.failure(
                    DatasourceException(
                        function = "MovChaveRoomDatasource.setSent",
                        cause = Exception()
                    )
                )
            )
    ...
    fun `checkOpen - Check return failure if have error in MovChaveRoomDatasource checkOpen`() =
        runTest {
            whenever(
                ...
                Result.failure(
                    DatasourceException(
                        function = "MovChaveRoomDatasource.checkOpen",
                        cause = Exception()
                    )
                )
            )
