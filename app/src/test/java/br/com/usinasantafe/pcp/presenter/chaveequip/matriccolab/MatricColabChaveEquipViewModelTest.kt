...
class MatricColabChaveEquipViewModelTest {
    ...
    private val getMatricColabMovChaveEquip = mock<GetMatricColabMovChaveEquip>()
    ...
    ) = MatricColabChaveEquipViewModel(
        savedStateHandle,
        updateColab,
        checkMatricColab,
    ...
    @Test
    fun `getMatricColab - Check return failure if have error in GetMatricColabMovChaveEquip`() =
        runTest {
            whenever(
