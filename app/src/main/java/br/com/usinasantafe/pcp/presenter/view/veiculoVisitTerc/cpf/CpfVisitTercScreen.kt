...
import br.com.usinasantafe.pcp.presenter.view.initial.matricvigia.TAG_NUMBER_TEXT_FIELD_MATRIC_VIGIA_SCREEN
...
fun CpfVisitTercScreen(
    viewModel: CpfVisitTercViewModel = hiltViewModel(),
    onNavTipo: () -> Unit,
    onNavDetalhe: () -> Unit,
