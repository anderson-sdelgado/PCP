...
public class VisitTercActivity extends ActivityGeneric {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visit_terc);
        ...
        buttonAtualPadrao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alerta = new AlertDialog.Builder(VisitTercActivity.this);
                alerta.setTitle("ATENÇÃO");
                ...
                alerta.setNegativeButton("SIM", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (connectNetwork) {
                            ...
                            progressBar = new ProgressDialog(VisitTercActivity.this);
                            progressBar.setCancelable(true);
                            progressBar.setMessage("ATUALIZANDO ...");
                            progressBar.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
                            progressBar.setProgress(0);
                            ...
                            pcpContext.getConfigCTR().atualDados(VisitTercActivity.this, VisitTercActivity.class, progressBar, "VisitanteTerceiro", 1, getLocalClassName());
    ...
    public void onBackPressed() {
        LogProcessoDAO.getInstance().insertLogProcesso("public void onBackPressed() {\n" +
                "        Intent it = new Intent(VisitanteTerceiroActivity.this, TipoVisitanteTerceiroActivity.class);", getLocalClassName());
        Intent it = new Intent(VisitTercActivity.this, TipoVisitTercActivity.class);
        startActivity(it);
        finish();
    }
