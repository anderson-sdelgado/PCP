package br.com.usinasantafe.pcp.presenter.view.chaveEquip.matriccolab
...
fun MatricColabChaveEquipScreen(
    viewModel: MatricColabChaveEquipViewModel = hiltViewModel(),
    onNavEquip: () -> Unit,
    onNavDetalhe: () -> Unit,
    ...
    Column(
        ...
        BackHandler {
            when (flowApp) {
                FlowApp.ADD -> {
                    when(typeMov){
                        TypeMovKey.REMOVE -> onNavMovList()
                        TypeMovKey.RECEIPT -> onNavEquip()
                    }
                }
