package br.com.usinasantafe.pcp.presenter.view.chaveEquip.controlelist
...
fun ControleChaveEquipListScreen(
    viewModel: ControleChaveEquipListViewModel = hiltViewModel(),
...
fun ControleChaveEquipListContent(
    ...
    Column(
        ...
        TitleDesign(
            text = stringResource(
                id = R.string.text_title_controle_chave_equip
            )
        )
        Spacer(modifier = Modifier.padding(vertical = 6.dp))
        LazyColumn(
