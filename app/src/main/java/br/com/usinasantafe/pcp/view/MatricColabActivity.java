...
public class MatricColabActivity extends ActivityGeneric {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAtualPadrao.setOnClickListener(v -> {
            ...
            alerta.setNegativeButton("SIM", (dialog, which) -> {
                ...
                if (connectNetwork) {
                    ...
                    AlertDialog.Builder alerta1 = new AlertDialog.Builder(MatricColabActivity.this);
        ...
        buttonOkMatricColab.setOnClickListener(v -> {
        ...
        buttonCancMatricColab.setOnClickListener(v -> {
