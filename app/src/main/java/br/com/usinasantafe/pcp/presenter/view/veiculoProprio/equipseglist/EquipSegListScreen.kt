package br.com.usinasantafe.pcp.presenter.view.veiculoProprio.equipseglist
...
fun EquipSegListScreen(
    viewModel: EquipSegListViewModel = hiltViewModel(),
    ...
    Column(
        ...
        if (flagDialogCheck) {
            AlertDialogCheckDesign(
                ...
                setActionButtonYes = setDeleteEquipSeg
            )
        }
