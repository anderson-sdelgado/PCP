...
public class VeiculoUsinaActivity extends ActivityGeneric {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAtualPadrao.setOnClickListener(v -> {
            ...
            alerta.setNegativeButton("SIM", (dialog, which) -> {
                ...
                if (connectNetwork) {
                    ...
                    AlertDialog.Builder alerta1 = new AlertDialog.Builder(VeiculoUsinaActivity.this);
        ...
        buttonOkVeicUsina.setOnClickListener(v -> {
        ...
        buttonCancVeicUsina.setOnClickListener(v -> {
