...
import br.com.usinasantafe.pcp.presenter.Screens.CHAVE_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MATRIC_COLAB_CHAVE_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.CONFIG_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.CPF_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.DESTINO_PROPRIO_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.DESTINO_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.DETALHE_CHAVE_EQUIP_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.DETALHE_CHAVE_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.DETALHE_PROPRIO_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.DETALHE_RESIDENCIA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.DETALHE_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.EQUIP_CHAVE_EQUIP_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.NRO_EQUIP_PROPRIO_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.EQUIP_SEG_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.INITIAL_TEST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.PASSAG_COLAB_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.LOCAL_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MATRIC_COLAB_CHAVE_EQUIP_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MATRIC_COLAB_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MATRIC_VIGIA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MENU_APONT_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MENU_INICIAL_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MOTORISTA_RESIDENCIA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.CONTROLE_CHAVE_EDIT_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.CONTROLE_CHAVE_EQUIP_EDIT_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.CONTROLE_CHAVE_EQUIP_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.CONTROLE_CHAVE_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MOV_EQUIP_PROPRIO_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MOV_EQUIP_RESIDENCIA_EDIT_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MOV_EQUIP_RESIDENCIA_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MOV_EQUIP_VISIT_TERC_EDIT_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.MOV_EQUIP_VISIT_TERC_LIST_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.NOME_COLAB_CHAVE_EQUIP_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.NOME_COLAB_CHAVE_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.NOME_COLAB_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.NOME_VIGIA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.NOME_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.NOTA_FISCAL_PROPRIO_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.OBSERV_CHAVE_EQUIP_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.OBSERV_CHAVE_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.OBSERV_PROPRIO_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.OBSERV_RESIDENCIA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.OBSERV_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.PASSAG_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.PLACA_RESIDENCIA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.PLACA_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.SENHA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.SPLASH_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.TIPO_VISIT_TERC_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.VEICULO_RESIDENCIA_SCREEN
import br.com.usinasantafe.pcp.presenter.Screens.VEICULO_VISIT_TERC_SCREEN
...
object Screens {
    ...
    const val MATRIC_COLAB_CHAVE_EQUIP_SCREEN = "matriccolabchaveequip"
    const val NOME_COLAB_CHAVE_EQUIP_SCREEN = "nomecolabchaveequip"
...
object Routes {
    ...
    const val MATRIC_COLAB_CHAVE_EQUIP_ROUTE = "$MATRIC_COLAB_CHAVE_EQUIP_SCREEN/{$FLOW_APP_ARGS}/{$TYPE_MOV_ARGS}/{$ID_ARGS}"
    const val NOME_COLAB_CHAVE_EQUIP_ROUTE = "$NOME_COLAB_CHAVE_EQUIP_SCREEN/{$FLOW_APP_ARGS}/{$TYPE_MOV_ARGS}/{$ID_ARGS}/{$MATRIC_COLAB_ARGS}"
...
class NavigationActions(private val navController: NavHostController) {
    ...
    fun navigateToMatricVigia() {
        navController.navigate(MATRIC_VIGIA_SCREEN)
    }

    fun navigateToNomeVigia() {
    ...
    fun navigateToMovEquipProprioList() {
        navController.navigate(MOV_EQUIP_PROPRIO_LIST_SCREEN)
    }

    fun navigateToMatricColab(
        flowApp: Int,
        typeOcupante: Int,
        id: Int
    ) {
    ...
    fun navigationToControleChaveEquipList() {
        navController.navigate(CONTROLE_CHAVE_EQUIP_LIST_SCREEN)
    }

    fun navigationToEquipChave(
        flowApp: Int,
        id: Int,
    ) {
        navController.navigate("${EQUIP_CHAVE_EQUIP_SCREEN}/${flowApp}/${id}")
    }

    fun navigationToMatriColabChaveEquip(
        flowApp: Int,
        typeMov: Int,
        id: Int,
    ) {
        navController.navigate("${MATRIC_COLAB_CHAVE_EQUIP_SCREEN}/${flowApp}/${typeMov}/${id}")
    }

    fun navigationToNomeColabChaveEquip(
        flowApp: Int,
        typeMov: Int,
        id: Int,
        matricColab: String
    ) {
        navController.navigate("${NOME_COLAB_CHAVE_EQUIP_SCREEN}/${flowApp}/${typeMov}/${id}/${matricColab}")
    }

    fun navigationToObservChaveEquip(
        flowApp: Int,
        typeMov: Int,
        id: Int
    ) {
        navController.navigate("${OBSERV_CHAVE_EQUIP_SCREEN}/${flowApp}/${typeMov}/${id}")
    }

    fun navigationToControleChaveEquipEditList() {
        navController.navigate(CONTROLE_CHAVE_EQUIP_EDIT_LIST_SCREEN)
    }

    fun navigationToDetalheChaveEquip(
        id: Int,
    ) {
        navController.navigate("${DETALHE_CHAVE_EQUIP_SCREEN}/${id}")
    }
