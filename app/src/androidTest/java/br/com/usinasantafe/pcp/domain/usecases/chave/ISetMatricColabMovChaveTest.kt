...
class ISetMatricColabMovChaveTest: KoinTest {
    ...
    fun check_return_failure_if_not_have_started_mov_chave() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetMatricColabMovChave -> IMovChaveRepository.setMatricColab -> IMovChaveSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_in_mov_chave_room_add() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetMatricColabMovChave -> IMovChaveRepository.setMatricColab -> IMovChaveRoomDatasource.setMatricColab"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
