...
class ISetObservResidenciaTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_and_flow_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetObservResidencia -> IMovEquipResidenciaRepository.setObserv -> IMovEquipResidenciaSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_and_flow_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetObservResidencia -> IMovEquipResidenciaRepository.setObserv -> IMovEquipResidenciaRoomDatasource.setObserv"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipResidenciaRoomModel.setObservMovEquipResidencia(java.lang.String)' on a null object reference"
            )
        }
    ...
    fun check_return_true_if_set_motorista_execute_success_and_flow_add_and_field_was_null() =
        runTest {
            ...
            assertEquals(
                entityBefore?.observMovEquipResidencia,
                null
            )
            val result = usecase(
                observ = "Teste Observ",
            ...
            assertEquals(
                entityAfter.observMovEquipResidencia,
                "Teste Observ"
            )
        }
