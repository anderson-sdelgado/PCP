...
class IGetMovEquipVisitTercOpenListTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_in_terceiro() =
        runTest {
            ...
            assertEquals(
                ...
                "IGetMovEquipVisitTercOpenList -> IGetMotoristaVisitTerc -> ITerceiroRepository.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_in_visitante() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetMovEquipVisitTercOpenList -> IGetMotoristaVisitTerc -> IVisitanteRepository.get"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
