...
class IGetMatricColabMovChaveEquipTest : KoinTest {

    private val usecase: GetMatricColabMovChaveEquip by inject()
    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "IGetMatricColabMovChaveEquip -> IMovChaveEquipRepository.getMatricColab"
            )
            assertEquals(
