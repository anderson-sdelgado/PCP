    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "ICloseMovChave -> IMovChaveRepository.setClose -> IMovChaveRoomDatasource.setClose"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovChaveRoomModel.setStatusMovChave(br.com.usinasantafe.pcp.utils.StatusData)' on a null object reference"
            )
        }
