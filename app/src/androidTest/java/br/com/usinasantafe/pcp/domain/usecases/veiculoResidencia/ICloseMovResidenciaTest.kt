...
class ICloseMovResidenciaTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "ICloseMovResidencia -> IMovEquipResidenciaRepository.setClose -> IMovEquipResidenciaRoomDatasource.setClose"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipResidenciaRoomModel.setStatusMovEquipResidencia(br.com.usinasantafe.pcp.utils.StatusData)' on a null object reference"
            )
        }
