...
class RecoverLocalServerImplTest : KoinTest {
    ...
    fun verify_return_failure_repository_if_data_incorrect() = runTest {
        ...
        assertEquals(result.exceptionOrNull()!!.cause.toString(), "java.lang.NullPointerException: Parameter specified as non-null is null: method br.com.usinasantafe.pcp.domain.entities.stable.Local.<init>, parameter descrLocal")
    }
