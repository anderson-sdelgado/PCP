...
class IGetDetalheMovChaveEquipTest : KoinTest {

    private val usecase: GetDetalheMovChaveEquip by inject()
    ...
    fun check_return_list_empty_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "IGetDetalheMovChaveEquip -> IMovChaveEquipRepository.get"
            )
    ...
    fun check_return_failure_if_not_have_data_in_equip_table() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetDetalheMovChaveEquip -> IEquipRepository.getDescr"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException"
