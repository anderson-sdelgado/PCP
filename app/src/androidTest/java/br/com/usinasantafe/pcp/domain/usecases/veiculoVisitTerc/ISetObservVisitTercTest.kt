...
class ISetObservVisitTercTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_and_flow_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetObservVisitTerc -> IMovEquipVisitTercRepository.setObserv -> IMovEquipVisitTercSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_and_flow_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetObservVisitTerc -> IMovEquipVisitTercRepository.setObserv -> IMovEquipVisitTercRoomDatasource.setObserv"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipVisitTercRoomModel.setObservMovEquipVisitTerc(java.lang.String)' on a null object reference"
            )
        }
    ...
    fun check_return_true_if_set_observ_execute_success_and_flow_add() =
        runTest {
            ...
            assertEquals(
                entityBefore.observMovEquipVisitTerc,
                "Teste"
            )
            val result = usecase(
                observ = "Teste Observ",
            ...
            assertEquals(
                entityAfter.observMovEquipVisitTerc,
                "Teste Observ"
            )
        }
