...
class ISetIdEquipMovChaveEquipTest: KoinTest {
    ...
    fun check_return_failure_if_not_have_data_in_equip_table() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetIdEquipMovChaveEquip -> IEquipRepository.getId"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_in_mov_chave_equip_shared_preferences_add() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetIdEquipMovChaveEquip -> IMovChaveEquipRepository.setIdEquip -> IMovChaveEquipSharedPreferencesDatasource.get"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
    ...
    fun check_return_failure_if_not_have_data_in_mov_chave_equip_room_add() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetIdEquipMovChaveEquip -> IMovChaveEquipRepository.setIdEquip -> IMovChaveEquipRoomDatasource.setIdEquip"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
