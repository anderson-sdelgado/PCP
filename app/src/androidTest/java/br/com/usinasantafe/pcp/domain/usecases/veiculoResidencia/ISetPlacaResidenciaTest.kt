...
class ISetPlacaResidenciaTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_and_flow_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetPlacaResidencia -> IMovEquipResidenciaRepository.setPlaca -> IMovEquipResidenciaSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_and_flow_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetPlacaResidencia -> IMovEquipResidenciaRepository.setPlaca -> IMovEquipResidenciaRoomDatasource.setPlaca"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipResidenciaRoomModel.setPlacaMovEquipResidencia(java.lang.String)' on a null object reference"
            )
        }
    ...
    fun check_return_true_if_set_motorista_execute_success_and_flow_add_and_field_was_null() =
        runTest {
            ...
            assertEquals(
                entityBefore?.placaMovEquipResidencia,
                null
            )
            val result = usecase(
                placa = "Teste Placa",
            ...
            assertEquals(
                entityAfter.placaMovEquipResidencia,
                "Teste Placa"
            )
        }
