...
class IGetMovChaveOpenListTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_in_chave_table() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetMovChaveOpenList -> IGetDescrFullChave -> IChaveRepository.get"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
    ...
    fun check_return_failure_if_not_have_data_in_local_trab_table() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetMovChaveOpenList -> IGetDescrFullChave -> ILocalTrabRepository.getDescr -> ILocalTrabRoomDatasource.getDescr"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
