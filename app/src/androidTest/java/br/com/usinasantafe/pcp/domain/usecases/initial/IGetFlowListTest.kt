    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "IGetFlowList -> IFluxoRepository.get"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Parameter specified as non-null is null: method br.com.usinasantafe.pcp.infra.models.room.stable.FluxoRoomModelKt.roomModelToEntity, parameter <this>"
            )
        }
