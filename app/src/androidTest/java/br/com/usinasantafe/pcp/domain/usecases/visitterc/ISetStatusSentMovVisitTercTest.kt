...
class ISetStatusSentMovVisitTercTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetStatusSentMovVisitTerc -> IMovEquipVisitTercRepository.setSent -> IMovEquipVisitTercRoomDatasource.setSent"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipVisitTercRoomModel.setStatusSendMovEquipVisitTerc(br.com.usinasantafe.pcp.utils.StatusSend)' on a null object reference"
            )
        }
    ...
    fun check_return_true_if_set_status_sent_execute_success_and_check_data() =
        runTest {
            ...
            assertEquals(
                entity1.statusSendMovEquipVisitTerc,
                StatusSend.SENT
            )
            val entity2 = movEquipVisitTercDao.get(2)
            assertEquals(
                entity2.statusSendMovEquipVisitTerc,
                StatusSend.SENT
            )
        }
