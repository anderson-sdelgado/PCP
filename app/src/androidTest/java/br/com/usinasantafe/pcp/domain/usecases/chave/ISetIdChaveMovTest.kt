...
class ISetIdChaveMovTest: KoinTest {
    ...
    fun check_return_failure_if_not_have_started_mov_chave_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetIdChaveMovChave -> IMovChaveRepository.setIdChave -> IMovChaveSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_started_mov_chave_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetIdChaveMovChave -> IMovChaveRepository.setIdChave -> IMovChaveRoomDatasource.setIdChave"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause!!.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovChaveRoomModel.setIdChaveMovChave(int)' on a null object reference"
            )
        }
