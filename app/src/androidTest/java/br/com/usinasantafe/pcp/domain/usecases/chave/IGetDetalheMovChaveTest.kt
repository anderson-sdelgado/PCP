...
class IGetDetalheMovChaveTest : KoinTest {
    ...
    fun check_return_list_empty_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "IGetDetalheMovChave -> IMovChaveRepository.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_in_chave_table() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetDetalheMovChave -> IGetDescrFullChave -> IChaveRepository.get"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
    ...
    fun check_return_failure_if_not_have_data_in_local_trab_table() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetDetalheMovChave -> IGetDescrFullChave -> ILocalTrabRepository.getDescr -> ILocalTrabRoomDatasource.getDescr"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
