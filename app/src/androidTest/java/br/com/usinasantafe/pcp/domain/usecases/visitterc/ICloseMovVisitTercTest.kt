...
class ICloseMovVisitTercTest: KoinTest {
    ...
    fun check_return_true_if_not_have_mov_open() = runTest {
        ...
        assertEquals(
            ...
            "ICloseMovVisitTerc -> IMovEquipVisitTercRepository.setClose -> IMovEquipVisitTercRoomDatasource.setClose"
        )
        assertEquals(
            result.exceptionOrNull()!!.cause.toString(),
            "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipVisitTercRoomModel.setStatusMovEquipVisitTerc(br.com.usinasantafe.pcp.utils.StatusData)' on a null object reference"
        )
    }
