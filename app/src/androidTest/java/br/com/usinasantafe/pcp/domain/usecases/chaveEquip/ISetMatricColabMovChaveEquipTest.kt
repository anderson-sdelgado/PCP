...
class ISetMatricColabMovChaveEquipTest: KoinTest {
    ...
    fun check_return_failure_if_not_have_started_mov_chave_equip_shared_preference_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetMatricColabMovChaveEquip -> IMovChaveEquipRepository.setMatricColab -> IMovChaveEquipSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_started_mov_chave_equip_room_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetMatricColabMovChaveEquip -> IMovChaveEquipRepository.setMatricColab -> IMovChaveEquipRoomDatasource.setMatricColab"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
