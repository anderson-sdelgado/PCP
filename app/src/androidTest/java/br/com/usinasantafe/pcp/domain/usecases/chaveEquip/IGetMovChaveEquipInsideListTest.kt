...
class IGetMovChaveEquipInsideListTest : KoinTest {

    private val usecase: GetMovChaveEquipInsideList by inject()
    ...
    fun check_return_failure_if_not_have_data_in_equip_table() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetMovChaveEquipInsideList -> IEquipRepository.getDescr"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException"
