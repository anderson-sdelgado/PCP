...
class ISetVeiculoVisitTercTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_and_flow_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetVeiculoVisitTerc -> IMovEquipVisitTercRepository.setVeiculo -> IMovEquipVisitTercSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_and_flow_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetVeiculoVisitTerc -> IMovEquipVisitTercRepository.setVeiculo -> IMovEquipVisitTercRoomDatasource.setVeiculo"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipVisitTercRoomModel.setVeiculoMovEquipVisitTerc(java.lang.String)' on a null object reference"
            )
        }
    ...
    fun check_return_true_if_set_placa_execute_success_and_flow_add() =
        runTest {
            ...
            assertEquals(
                entityAfter.veiculoMovEquipVisitTerc,
                "Teste Veiculo"
            )
        }
    ...
    fun check_return_true_if_set_placa_execute_success_and_flow_change() =
        runTest {
            ...
            assertEquals(
                entityBefore.veiculoMovEquipVisitTerc,
                "VEICULO TESTE"
            )
            val result = usecase(
                veiculo = "Teste Veiculo",
