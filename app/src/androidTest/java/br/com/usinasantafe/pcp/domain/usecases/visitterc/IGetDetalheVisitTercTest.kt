...
class IGetDetalheVisitTercTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data() = runTest {
        ...
        assertEquals(
            ...
            "IGetDetalheVisitTerc -> IMovEquipVisitTercRepository.get"
        )
        assertEquals(
    ...
    fun check_return_failure_if_not_have_data_terc() = runTest {
        ...
        assertEquals(
            result.exceptionOrNull()!!.message,
            "IGetDetalheVisitTerc -> IGetMotoristaVisitTerc -> ITerceiroRepository.get"
        )
        assertEquals(
            result.exceptionOrNull()!!.cause.toString(),
    ...
    fun check_return_failure_if_not_have_data_visit() = runTest {
        ...
        assertEquals(
            result.exceptionOrNull()!!.message,
            "IGetDetalheVisitTerc -> IGetMotoristaVisitTerc -> IVisitanteRepository.get"
        )
        assertEquals(
            result.exceptionOrNull()!!.cause.toString(),
            "java.lang.NullPointerException"
