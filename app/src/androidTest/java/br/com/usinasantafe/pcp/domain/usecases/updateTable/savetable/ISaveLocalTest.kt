...
class ISaveLocalTest: KoinTest {
    ...
    fun check_return_failure_if_have_row_repeated() = runTest {
        ...
        assertEquals(
            ...
            "ISaveLocal -> ILocalRepository.addAll -> ILocalRoomDatasource.addAll"
        )
        assertEquals(
            result.exceptionOrNull()!!.cause.toString(),
            "android.database.sqlite.SQLiteConstraintException: UNIQUE constraint failed: tb_local.idLocal (code 1555 SQLITE_CONSTRAINT_PRIMARYKEY[1555])"
        )
    }
