...
class ISetStatusSentMovResidenciaTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetStatusSentMovResidencia -> IMovEquipResidenciaRepository.setSent -> IMovEquipResidenciaRoomDatasource.setSent"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipResidenciaRoomModel.setStatusSendMovEquipResidencia(br.com.usinasantafe.pcp.utils.StatusSend)' on a null object reference"
            )
        }
    ...
    fun check_return_true_if_set_status_sent_execute_success_and_check_data() =
        runTest {
            ...
            assertEquals(
                entity1.statusSendMovEquipResidencia,
                StatusSend.SENT
            )
            val entity2 = movEquipResidenciaDao.get(2)
            assertEquals(
                entity2.statusSendMovEquipResidencia,
                StatusSend.SENT
            )
        }
}