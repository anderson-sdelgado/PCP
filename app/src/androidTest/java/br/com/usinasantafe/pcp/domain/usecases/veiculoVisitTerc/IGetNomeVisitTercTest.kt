...
class IGetNomeVisitTercTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_and_flow_add() =
        runTest {
            ...
            assertEquals(
                ...
                "IGetNomeVisitTerc -> IMovEquipVisitTercRepository.getTypeVisitTerc -> IMovEquipVisitTercSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_in_visitante_and_flow_add() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetNomeVisitTerc -> IVisitanteRepository.getNome"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException"
    ...
    fun check_return_failure_if_not_have_data_in_terceiro_and_flow_add() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetNomeVisitTerc -> ITerceiroRepository.getId"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
