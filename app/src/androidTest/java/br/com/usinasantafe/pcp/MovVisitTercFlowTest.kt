...
import br.com.usinasantafe.pcp.presenter.visitterc.destino.TAG_DESTINO_TEXT_FIELD_VISIT_TERC
import br.com.usinasantafe.pcp.presenter.visitterc.observ.TAG_OBSERV_TEXT_FIELD_VISIT_TERC
import br.com.usinasantafe.pcp.presenter.visitterc.placa.TAG_PLACA_TEXT_FIELD_VISIT_TERC
import br.com.usinasantafe.pcp.presenter.visitterc.veiculo.TAG_VEICULO_TEXT_FIELD_VISIT_TERC
...
class MovVisitTercFlowTest : KoinTest {
    ...
    fun mov_visit_terc_flow_terceiro() = runTest {
        ...
        composeTestRule.onNodeWithTag("item_list_93562").performClick()
        ...
        composeTestRule.onNodeWithTag(TAG_DESTINO_TEXT_FIELD_VISIT_TERC)
            .performTextClearance()
        composeTestRule.onNodeWithTag(TAG_DESTINO_TEXT_FIELD_VISIT_TERC)
            .performTextInput("TI - DONIZETE - ALTERADO")
        composeTestRule.onNodeWithText("OK").performClick()
        ...
        composeTestRule.onNodeWithTag(TAG_OBSERV_TEXT_FIELD_VISIT_TERC)
            .performTextClearance()
        composeTestRule.onNodeWithTag(TAG_OBSERV_TEXT_FIELD_VISIT_TERC)
            .performTextInput("TESTE OBSERV ALTERADO")
        composeTestRule.onNodeWithText("OK").performClick()
