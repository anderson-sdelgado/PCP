...
class ISaveMovChaveTest : KoinTest {
    ...
    fun check_return_failure_if_not_have_data_in_mov_chave_shared_preferences_remove() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISaveMovChave -> IMovChaveRepository.save -> IMovChaveSharedPreferencesDatasource.get"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause!!.toString(),
                "java.lang.NullPointerException"
    ...
    @Test
    fun check_return_failure_if_not_have_data_in_mov_room_receipt() =
        runTest {
            val result = usecase(
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISaveMovChave -> IMovChaveRepository.setOutside -> IMovChaveRoomDatasource.setOutside"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause!!.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovChaveRoomModel.setStatusForeignerMovChave(br.com.usinasantafe.pcp.utils.StatusForeigner)' on a null object reference"
            )
        }
