...
import br.com.usinasantafe.pcp.presenter.chave.chavelist.TAG_FILTER_TEXT_FIELD_CHAVE_LIST_SCREEN
...
class MovChaveFlowTest : KoinTest {
    ...
    fun main_flow() = runTest {
        ...
        composeTestRule.onNodeWithText("OBSERVAÇÃO").assertIsDisplayed()
        composeTestRule.onNodeWithTag(TAG_OBSERV_TEXT_FIELD_CHAVE)
            .performTextInput("TESTE RECEBIMENTO")
        composeTestRule.onNodeWithText("OK").performClick()
        ...
        composeTestRule.onNodeWithText("MOVIMENTO").assertIsDisplayed()
        composeTestRule.onNodeWithTag("item_list_1").performClick()
        ...
        composeTestRule.onNodeWithTag(TAG_OBSERV_TEXT_FIELD_CHAVE).performTextInput("TESTE RETORNO alterado")
        composeTestRule.onNodeWithText("OK").performClick()
