...
class IGetPassagVisitTercListTest : KoinTest {
    ...
    fun check_return_failure_if_have_passag_but_not_have_type_visit_terc_and_flow_add() =
        runTest {
            ...
            assertEquals(
                ...
                "IGetPassagVisitTercList -> IMovEquipVisitTercRepository.getTypeVisitTerc -> IMovEquipVisitTercSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_have_passag_and_have_type_visit_but_not_have_visit_and_flow_add() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetPassagVisitTercList -> IVisitanteRepository.getCpf"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException"
    ...
    fun check_return_failure_if_have_passag_and_have_type_terc_visit_but_not_have_terc_and_flow_add() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "IGetPassagVisitTercList -> ITerceiroRepository.getCpf"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
