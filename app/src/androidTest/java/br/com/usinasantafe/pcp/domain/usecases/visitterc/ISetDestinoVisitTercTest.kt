...
class ISetDestinoVisitTercTest: KoinTest {
    ...
    fun check_return_failure_if_not_have_data_and_flow_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetDestinoVisitTerc -> IMovEquipVisitTercRepository.setDestino -> IMovEquipVisitTercSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_data_and_flow_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetDestinoVisitTerc -> IMovEquipVisitTercRepository.setDestino -> IMovEquipVisitTercRoomDatasource.setDestino"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
                "java.lang.NullPointerException: Attempt to invoke virtual method 'void br.com.usinasantafe.pcp.infra.models.room.variable.MovEquipVisitTercRoomModel.setDestinoMovEquipVisitTerc(java.lang.String)' on a null object reference"
            )
        }
    ...
    fun check_return_true_if_set_destino_execute_success_and_flow_add() =
        runTest {
            ...
            assertEquals(
                entityBefore.destinoMovEquipVisitTerc,
                "Teste"
            )
            val result = usecase(
                destino = "Teste Destino",
            ...
            assertEquals(
                entityAfter.destinoMovEquipVisitTerc,
                "Teste Destino"
            )
        }
    ...
    fun check_return_true_if_set_destino_execute_success_and_flow_change() =
        runTest {
            ...
            assertEquals(
                entityAfter.statusSendMovEquipVisitTerc,
                StatusSend.SEND
            )
        }
}