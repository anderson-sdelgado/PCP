...
class ISetObservMovChaveEquipTest: KoinTest {
    ...
    fun check_return_failure_if_not_have_started_mov_chave_equip_shared_preference_add() =
        runTest {
            ...
            assertEquals(
                ...
                "ISetObservMovChaveEquip -> IMovChaveEquipRepository.setObserv -> IMovChaveEquipSharedPreferencesDatasource.get"
            )
            assertEquals(
    ...
    fun check_return_failure_if_not_have_started_mov_chave_equip_room_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "ISetObservMovChaveEquip -> IMovChaveEquipRepository.setObserv -> IMovChaveEquipRoomDatasource.setObserv"
            )
            assertEquals(
                result.exceptionOrNull()!!.cause.toString(),
